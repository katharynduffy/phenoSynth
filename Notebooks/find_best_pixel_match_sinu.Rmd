...
appeears_tasks_ndvi_t     = readRDS(file = paste0(file_root,'/www/cache_df_ndvi_tera.df'))
appeears_tasks_ndvi_a     = readRDS(file = paste0(file_root,'/www/cache_df_ndvi_aqua.df'))
...
appeears_tasks_evi_t      = readRDS(file = paste0(file_root,'/www/cache_df_evi_tera.df'))
appeears_tasks_evi_a      = readRDS(file = paste0(file_root,'/www/cache_df_evi_aqua.df'))
```

grab acadia data
```{r}
# Grab acadia tasks for ndvi/evi/tds from cached AppEEARS dataframes
ndvi_task_t = appeears_tasks_ndvi_t[grep('acadia' ,appeears_tasks_ndvi_t$task_name),]
ndvi_task_a = appeears_tasks_ndvi_a[grep('acadia' ,appeears_tasks_ndvi_a$task_name),]
tds_task  = appeears_tasks_tds[grep('acadia' ,appeears_tasks_tds$task_name),]
evi_task_t  = appeears_tasks_evi_t[grep('acadia' ,appeears_tasks_evi_t$task_name),]
evi_task_a  = appeears_tasks_evi_a[grep('acadia' ,appeears_tasks_evi_a$task_name),]
```
...
lc_task_id_nc   = '3b788e45-6ed4-4d66-9dbe-38f5fea98f08'
lc_task_id_tiff = '519fc322-a80c-4373-a036-b7aa6223892c'
...
# leaflet() %>% addTiles() %>% addRasterImage(lc_raster_merc, opacity = 1, colors = colors_) %>% addRasterImage(ndvi_raster_merc, opacity = .2)
...
r_500_m_cropped_merc_20 = crop_raster(lat_merc, lng_merc, lc_raster_merc, height = 20000, width = 20000, crs_str = merc_crs)
