...
library(dplyr)
map1 = leaflet(options = leafletOptions(zoomControl = FALSE)) %>% addTiles() %>% addRasterImage(rc_nlcd, colors = rc_nlcd_c$palette, opacity = 1, layerId = 'NLCD Landcover') %>%
...
Add modis grid
```{r}
modis_ndvi = '../../www/site_data/ibp/data_layers/ndvi/tera/MOD13Q1.006_250m_aid0001.nc'
