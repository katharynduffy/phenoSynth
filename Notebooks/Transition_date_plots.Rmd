...
```{r}
<<<<<<< HEAD
gcc    = read.csv('/users/kenns/projects/r/apis/phenosynth/www/site_data/acadia/data_layers/gcc_3_day.csv')
spring = read.csv('/users/kenns/projects/r/apis/phenosynth/www/site_data/acadia/data_layers/gcc_3_day_spring_tds.csv')
fall   = read.csv('/users/kenns/projects/r/apis/phenosynth/www/site_data/acadia/data_layers/gcc_3_day_fall_tds.csv')
=======
...
```{r}
ndvi    = read.csv('/Users/kdw223/Google Drive/PhenoPostdoc/phenoRemote/www/site_data/acadia/data_layers/ndvi_ddmmyyyy.csv')
```
```{r}
p = plot_ly(
            data = df_test,
