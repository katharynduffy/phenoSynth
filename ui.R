...
ui = fluidPage(shinyjs::useShinyjs(), includeCSS("./Aesthetics/styles.css"),
               ...
               navbarPage("PhenoSynth-development phase", id="navbar",
                        ...
                        absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE,
                                      ...
                                      checkboxInput("drawImageROI", "Show ROI on PhenoCam Image", value = FALSE), #Kyle when I try and ditch this we get an error, I'm guessing that it's because we're pulling in the ROI here, I'll work on this
